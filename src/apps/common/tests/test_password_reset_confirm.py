...
from apps.common.tests.common import create_user


class PasswordResetConfirmViewTest(APITestCase, assertions.EmailAssertionsMixin, assertions.StatusCodeAssertionsMixin):
    def setUp(self):
    ...
    @override_settings(DJOSER=dict(settings.DJOSER, **{"PASSWORD_CHANGED_EMAIL_CONFIRMATION": True}))
