...
def supplier_profit(supplier_id) -> Manager[PurchasesSalesHistorySupplier]:
    ...
    """
    return PurchasesSalesHistorySupplier.objects.get_sales_profit(id=supplier_id, type='supplier')
...
def supplier_sold_cars_amount(supplier_id) -> Manager[PurchasesSalesHistorySupplier]:
    ...
    """
    return PurchasesSalesHistorySupplier.objects.get_sold_cars_amount(id=supplier_id, type='supplier')
...
def supplier_sold_cars_profit(supplier_id) -> Manager[PurchasesSalesHistorySupplier]:
    ...
    """
    return PurchasesSalesHistorySupplier.objects.get_sold_cars_profit(id=supplier_id, type='supplier')
