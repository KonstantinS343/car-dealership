    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, max_digits=10, validators=[django.core.validators.MinValueValidator(0.0)], verbose_name='Итоговая цена')),
                ('buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purchases_history_car_show_buyer', to='buyer.buyer', verbose_name='Покупатель')),
