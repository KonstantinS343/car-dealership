...
from .models import PurchasesSalesHistorySupplier, PurchasesSalesHistoryСarShow
...
class PurchasesSalesHistorySupplierAdmin(admin.ModelAdmin):
    fieldsets = (
        ...
        (_("Автомобиль"), {"fields": ("car_model",), }, ),
        (_("Права Доступа"), {"fields": ("is_active",), }, ),
        (_("Активен"), {"fields": ("final_price",), }, ),
    )
